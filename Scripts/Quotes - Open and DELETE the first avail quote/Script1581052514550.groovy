...
WebUI.verifyElementPresent(findTestObject('MyFreight-Users/Page_Myfreight/Quotes/div_Quoterow'), 1, FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('MyFreight-Users/Page_Myfreight/Quotes/a_QuoteNumber'), 0)

WebUI.click(findTestObject('MyFreight-Users/Page_Myfreight/Quotes/a_QuoteNumber'))

WebUI.click(findTestObject('MyFreight-Users/Page_Myfreight/Quotes/button_Delete'))
