 ...
 * When I login with valid username and encrypted password
...
WebUI.setEncryptedText(findTestObject('Test Objects/Pages/Login Page/elPassword'), GlobalVariable.encrypted_password)
